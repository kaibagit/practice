...
public class CrudExamples
{
    public static void main(String[] args) throws Exception {
        ...
        client.start();
        create(client,"/curator/test","hello".getBytes());
    }
    ...
    public static List<String> defaultWatchedGetChildren(CuratorFramework client, String path) throws Exception
    {
        /**
    ...
    public static List<String> watchedGetChildren(CuratorFramework client, String path) throws Exception
    {
         ...
         */
        return client.getChildren().usingWatcher(new Watcher() {
            @Override
