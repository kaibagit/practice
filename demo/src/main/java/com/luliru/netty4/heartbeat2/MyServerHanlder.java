package com.luliru.netty4.heartbeat2;
...
public class MyServerHanlder extends ChannelHandlerAdapter{
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ...
        //通知您已经链接上客户端
        String str = "您已经开启与服务端链接"+" "+ctx.channel()+new Date()+" "+ctx.channel().localAddress();
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg)
        ...
        //注意此处已经不需要手工解码了
        System.out.println(ctx.channel()+""+new Date()+" "+msg);

        //通知您已经链接上客户端[给客户端穿回去的数据加个换行]
        String str = "服务端收到："+ctx.channel()+new Date()+" "+msg+"\r\n";
