...
public class 剑指25_合并两个有序链表 {
    ...
    public static void main(String[] args) {
        ...
        ListNode result = new 剑指25_合并两个有序链表().mergeTwoLists_210224(n1_1,n2_1);
        System.out.println(result);
    }

    public ListNode mergeTwoLists_210224(ListNode l1, ListNode l2) {
